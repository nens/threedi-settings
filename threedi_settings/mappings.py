...
time_step_settings_map = {
    ...
    "min_time_step": [
        ...
        FieldInfoSqlite("minimum_sim_time_step", float, SettingsTables.global_settings.value),
    ],
    "max_time_step": [
        FieldInfoIni("maximum_timestep", float, "simulation"),
        FieldInfoAPI("max_time_step", float, 1.0),
        FieldInfoSqlite("maximum_sim_time_step", float, SettingsTables.global_settings.value),
    ],
    ...
    "output_time_step": [
        ...
        FieldInfoSqlite("output_time_step", float, SettingsTables.global_settings.value),
    ],
}
...
numerical_settings_map = {
    "cfl_strictness_factor_1d": [
        ...
        FieldInfoSqlite("cfl_strictness_factor_1d", float, SettingsTables.numerical_settings.value),
    ],
    ...
    "flooding_threshold": [
        ...
        FieldInfoSqlite("flooding_threshold", float,
                        SettingsTables.global_settings.value),
    ],
}
...
aggregation_settings_map = {
    "flow_variable": [
        ...
        FieldInfoSqlite("flow_variable", str,
                        SettingsTables.aggregation_settings.value),
    ],
    "method": [
